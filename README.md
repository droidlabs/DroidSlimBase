...
Small boilerplate with Slim & [DroidCSS](http://github.com/droidlabs/droidcss) support.

## [DroidCSS Grid Demo](http://droidlabs.github.io/droidcss/)

## What's under the hood?

* Basic HTML+Slim markup
* CSS Reset
* CSS3 Mixins
* Compiled CSS file (from SCSS)

## How to use with Slim+SCSS

On Mac it's easy to use it with:

* [Slim Gem](http://slim-lang.com/) + [SASS/SCSS Gem](http://sass-lang.com/download.html)
* [CodeKit](http://incident57.com/codekit/)
* [Hammer](http://www.hammerformac.com/)
* [LiveReload](http://www.livereload.com/)

## Variables for DroidCSS

All the variables can be found in css/droidcss/partials/setup.scss file
...
Feel free to contact us regarding DroidSlimBase via [twitter](http://twitter.com/droidlabs) or [email](mailto:ilya@droidlabs.pro).

## Thanks for using DroidSlimBase
